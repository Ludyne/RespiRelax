...
class BreathingApp {
    constructor(){
        ...
        console.log("Form trouv\xe9:", this.form);
        console.log("Breath ratio select:", this.form.querySelector("#breath-ratio"));
        ...
        window.addEventListener("keydown", (e)=>{
            if (e.key === "Escape" && this.isRunning) this.stopExercise();
        });
    ...
    updateAnimation() {
        ...
        if (this.animation === "position") circle.classList.add("exercice-disc-position");
    }
    startExercise() {
